        ...
        <div className="mx-auto grid w-full max-w-4xl items-center gap-10 md:grid-cols-[1.1fr,1fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-md text-sm text-neutral-700">
              Access your CORUS student portal to view enrollment, grades,
              billing, announcements, and more using your registered email
              credentials.
            </p>
          </div>
                ...
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2">
                    <input
                      id="remember"
                      type="checkbox"
                      className="h-3.5 w-3.5 rounded border border-neutral-300 text-[#6A0000] focus-visible:ring-[#6A0000]"
                    />
                    <label
                      htmlFor="remember"
